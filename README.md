...
### 安装要求
1. 安装**BepInEx IL2CPP**版本（不是普通的Mono版本）
2. 确保BepInEx已经生成了IL2CPP interop程序集（第一次运行VRoid Studio后自动生成）
3. 将插件DLL放入`BepInEx\plugins`文件夹

### 注意事项
- 如果使用的是VRoid Studio 1.26.0或更早的Mono版本，请使用0.8.2或更早版本的插件
- IL2CPP版本和Mono版本的插件**不能**互换使用
